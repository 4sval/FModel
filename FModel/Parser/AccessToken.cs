...
namespace FModel.Parser.Access
{
    using System;
    ...
    public partial class AccessToken
    {
        public static AccessToken FromJson(string json) => JsonConvert.DeserializeObject<AccessToken>(json, FModel.Parser.Access.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this AccessToken self) => JsonConvert.SerializeObject(self, FModel.Parser.Access.Converter.Settings);
    }
