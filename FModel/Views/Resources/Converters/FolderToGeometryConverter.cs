    ...
    public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
    {
        ...
        if (targetType == typeof(Geometry))
        {
            var resource = folderName switch
            {
                ...
                "curves" => "CurveIcon",
                "bp" or "blueprint" or "blueprints" or "audioblueprints" => "BlueprintIcon",
                "staticmesh" or "mesh" or "meshes" or "model" or "models" or "characters" or "environment" or "props" => "StaticMeshIconAlt",
        ...
        if (targetType == typeof(Brush))
        {
            Brush brush = folderName switch
            {
                ...
                "curves" => Brushes.HotPink,
                "bp" or "blueprint" or "blueprints" or "audioblueprints" => Brushes.DodgerBlue,
