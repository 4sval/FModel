...
namespace FModel.Windows.AvalonEditFindReplace
{
    ...
    /// </summary>
    public class AvalonEditFindReplaceHelper : DependencyObject
    {
        private AvalonEditFindReplace _dialog = null;
        /// <summary>
        /// Instance of the dialog window
        /// </summary>
        AvalonEditFindReplace Dialog
        {
            get
            {
                if (_dialog == null)
                {
                    _dialog = new AvalonEditFindReplace(this);
        ...
        public AvalonEditFindReplaceHelper()
        {
            ReplacementText = "";
        ...
        public static readonly DependencyProperty EditorsProperty =
            DependencyProperty.Register("Editors", typeof(IEnumerable), typeof(AvalonEditFindReplaceHelper), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty CurrentEditorProperty =
            DependencyProperty.Register("CurrentEditor", typeof(object), typeof(AvalonEditFindReplaceHelper), new PropertyMetadata(0));
        ...
        public static readonly DependencyProperty InterfaceConverterProperty =
            DependencyProperty.Register("InterfaceConverter", typeof(IValueConverter), typeof(AvalonEditFindReplaceHelper), new PropertyMetadata(null));

        public static readonly DependencyProperty TextToFindProperty =
        DependencyProperty.Register("TextToFind", typeof(string),
        typeof(AvalonEditFindReplaceHelper), new UIPropertyMetadata(""));
        ...
        public static readonly DependencyProperty UseWildcardsProperty =
            DependencyProperty.Register("UseWildcards", typeof(bool), typeof(AvalonEditFindReplaceHelper), new UIPropertyMetadata(false));
        ...
        public static readonly DependencyProperty SearchUpProperty =
            DependencyProperty.Register("SearchUp", typeof(bool), typeof(AvalonEditFindReplaceHelper), new UIPropertyMetadata(false));
        ...
        public static readonly DependencyProperty CaseSensitiveProperty =
            DependencyProperty.Register("CaseSensitive", typeof(bool), typeof(AvalonEditFindReplaceHelper), new UIPropertyMetadata(false));
        ...
        public static readonly DependencyProperty UseRegExProperty =
            DependencyProperty.Register("UseRegEx", typeof(bool), typeof(AvalonEditFindReplaceHelper), new UIPropertyMetadata(false));
        ...
        public static readonly DependencyProperty WholeWordProperty =
            DependencyProperty.Register("WholeWord", typeof(bool), typeof(AvalonEditFindReplaceHelper), new UIPropertyMetadata(false));
        ...
        public static readonly DependencyProperty AcceptsReturnProperty =
            DependencyProperty.Register("AcceptsReturn", typeof(bool), typeof(AvalonEditFindReplaceHelper), new UIPropertyMetadata(false));
        ...
        public static readonly DependencyProperty SearchInProperty =
            DependencyProperty.Register("SearchIn", typeof(SearchScope), typeof(AvalonEditFindReplaceHelper), new UIPropertyMetadata(SearchScope.CurrentDocument));
        ...
        public static readonly DependencyProperty ShowSearchInProperty =
            DependencyProperty.Register("ShowSearchIn", typeof(bool), typeof(AvalonEditFindReplaceHelper), new UIPropertyMetadata(true));
        ...
        public static readonly DependencyProperty AllowReplaceProperty =
            DependencyProperty.Register("AllowReplace", typeof(bool), typeof(AvalonEditFindReplaceHelper), new UIPropertyMetadata(true));
        ...
        public static readonly DependencyProperty OwnerWindowProperty =
            DependencyProperty.Register("OwnerWindow", typeof(Window), typeof(AvalonEditFindReplaceHelper), new UIPropertyMetadata(null));
    ...
    public class SearchScopeToInt : IValueConverter
    {
        ...
        {
            return (AvalonEditFindReplaceHelper.SearchScope)value;
        }
